...
def read_students_from_file(filename):
    ...
    for line in lines:
        ...
        try:
            ...
            # Print an error message and return an empty list
            print(f"Error: Information at line {lines.index(line)} in {filename} is not correct.")
            return []
...
def main():
    ...
    # Create a filenmae variable to store the filepath
